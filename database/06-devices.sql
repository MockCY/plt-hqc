...
CREATE TABLE IF NOT EXISTS devices (
    ...
    created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id), UNIQUE KEY uk_devices_code (code), UNIQUE KEY uk_devices_serial_number (serial_number), KEY idx_devices_category_active (category, active), KEY idx_devices_active_sort (active, sort_order),
...
INSERT INTO devices(code, name, category, serial_number, device_model, bed_type, spring_config, purchased_on, connected, active, sort_order) VALUES
    ('FLEX_AIR_HOME', 'Arvello 柔力核心床', '核心床', 'ARV240428MNT001', 'Arvello 柔力核心床', '标准款 · Mint', '轻弹簧 / 中弹簧 / 重弹簧', '2024-04-28', TRUE, TRUE, 10),
    ('FLEX_AIR_STUDIO', 'Arvello Studio 核心床', '核心床', 'ARV240428STD002', 'Arvello Studio 核心床', '专业款 · Sage', '轻弹簧 / 中弹簧 / 重弹簧', '2024-04-28', FALSE, TRUE, 20),
    ('BODYWEIGHT', '徒手训练', '徒手训练', 'ARV-BODYWEIGHT-001', '徒手训练', '不适用', '不适用', NULL, TRUE, TRUE, 30)
